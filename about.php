...
<!-- End Google Tag Manager -->    
            <meta name="description" content="We want everyone to be able to decorate their homes with artwork that celebrate all of life’s precious moments, memories & milestones. Personal artwork that tell your own, unique story.">
        <meta name="twitter:card" property="twitter:card" content="summary">
        <meta property="og:site_name" content="Louvenir">
        <meta property="og:title" content="About Louvenir">
        <meta property="og:url" content="https://www.louvenir.com/about-louvenir">
        <meta property="og:description" content="We want everyone to be able to decorate their homes with artwork that celebrate all of life’s precious moments, memories & milestones. Personal artwork that tell your own, unique story.">
...
<body class="page-loading page-about-louvenir bullets-row-is-visible">
...
<div class="container mt-4 mt-lg-5">
		<div class="row pb-5">
			<div class="col-12 col-lg-6 mb-3">
				<img src="asaaab/user/themes/base/images/placeholder/ph-4x3.gif.html" loading="lazy" data-src="https://d361gbievcxqh7.cloudfront.net/asaaab/user/themes/base/images/hero/hero-allposters-2.jpg" width="1200" height="900">
			</div>

			<div class="col-12 col-lg-6 pl-lg-4">
				<h1>О Mappin</h1> <p class="h3 txt-dark-gray">Мы хотим, чтобы каждый мог украсить свой дом произведениями искусства, отражающими все драгоценные моменты, воспоминания и воспоминания о жизни. вехи. Персональные работы, рассказывающие вашу уникальную историю. </p>
<p> Произведение, оживляющее прекрасные воспоминания и эмоции. И для себя, и для всех, кого вы дорожите своим сердцем. Место, где вы можете разработать личные подарки, которые будут продуманными и покажут, как много для вас кто-то значит.
   Всегда изготавливаются из лучших материалов, одобренных ведущими музеями и галереями как подходящие для воспроизведения традиционного искусства. Просто лучшее качество, соответствующее эмоциональной ценности, вложенной в произведение искусства.
</p>
<div class="testimonial"> <p>Мы выбрали название Louvenir как сочетание слов «Сувенир» (по-французски «воспоминания») и «Любовь». Все дело в создании милых сувениров от души - сделанных с любовью, сделанных для вас!</p> </div>
    ...
    <div class="container text-center mt-3 mb-0 mt-md-5">
			<div class="position-relative">
			<h2 class="title-line-header position-relative bg-white text-center pl-md-4 pr-md-4">Наши самые популярные персонализированные редакторы плакатов</h2>
			<div class="title-line-border d-none d-md-block"></div>
		</div>
	
	</div>

<div class="container container-carousel links-no-style position-relative mb-3 hidden">
		...
		<div class="carousel-inner d-flex">
				...
				<a href="personalised-star-map-poster/spU5F5.html" class="carousel-image-link d-inlineblock text-center d-flex flex-column" js-action-click="carousel-item-clicked">
					...
					<div class="carousel-info">
													<span class="text-small d-block txt-dark-gray strong">Постер картой</span>
												<span class="text-smallest txt-color-gray price-from d-block font-italic">Из 20 000 Тг</span>
					</div>
				</a>
				...
				<a href="personalised-birth-poster/stt7A3.html" class="carousel-image-link d-inlineblock text-center d-flex flex-column" js-action-click="carousel-item-clicked">
					<span class="d-flex align-items-center justify-content-center flex-1"><img src="asaaab/user/themes/base/images/placeholder/ph-5x7.gif" loading="lazy" data-src="https://d1w0afvwsjp99f.cloudfront.net/en/images/500x700/poster-birth/tt7A3/poster-birth.jpg" draggable="false" class="mb-3 border-gray" width="500" height="700"></span>
					<div class="carousel-info">
												<span class="text-small d-block txt-dark-gray strong">Постер картой</span>
												<span class="text-smallest txt-color-gray price-from d-block font-italic">Из 20 000 Тг</span>
					</div>
				...
				<a href="personalised-coordinate-poster/smK6D2.html" class="carousel-image-link d-inlineblock text-center d-flex flex-column" js-action-click="carousel-item-clicked">
					<span class="d-flex align-items-center justify-content-center flex-1"><img src="asaaab/user/themes/base/images/placeholder/ph-5x7.gif" loading="lazy" data-src="https://d1w0afvwsjp99f.cloudfront.net/en/images/500x700/poster-coordinate/mK6D2/poster-coordinate.jpg" draggable="false" class="mb-3 border-gray" width="500" height="700"></span>
					<div class="carousel-info">
													<span class="text-small d-block txt-dark-gray strong">Постер картой</span>
												<span class="text-smallest txt-color-gray price-from d-block font-italic">Из 20 000 Тг</span>
					</div>
				...
				<a href="personalised-stadium-poster/scm6Y4.html" class="carousel-image-link d-inlineblock text-center d-flex flex-column" js-action-click="carousel-item-clicked">
					<span class="d-flex align-items-center justify-content-center flex-1"><img src="asaaab/user/themes/base/images/placeholder/ph-5x7.gif" loading="lazy" data-src="https://d1w0afvwsjp99f.cloudfront.net/en/images/500x700/poster-stadium/cm6Y4/poster-stadium.jpg" draggable="false" class="mb-3 border-gray" width="500" height="700"></span>
					<div class="carousel-info">
													<span class="text-small d-block txt-dark-gray strong">Постер картой</span>
												<span class="text-smallest txt-color-gray price-from d-block font-italic">Из 20 000 Тг</span>
					</div>
				...
				<a href="personalised-zodiac-poster/svH0b6.html" class="carousel-image-link d-inlineblock text-center d-flex flex-column" js-action-click="carousel-item-clicked">
					<span class="d-flex align-items-center justify-content-center flex-1"><img src="asaaab/user/themes/base/images/placeholder/ph-5x7.gif" loading="lazy" data-src="https://d1w0afvwsjp99f.cloudfront.net/en/images/500x700/poster-zodiac/vH0b6/poster-zodiac.jpg" draggable="false" class="mb-3 border-gray" width="500" height="700"></span>
					<div class="carousel-info">
													<span class="text-small d-block txt-dark-gray strong">Постер картой</span>
												<span class="text-smallest txt-color-gray price-from d-block font-italic">Из 20 000 Тг</span>
					</div>
